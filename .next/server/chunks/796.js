...
var react_1 = __importStar(__webpack_require__(46261));
var prop_types_1 = __importDefault(__webpack_require__(11770));
var clsx_1 = __importDefault(__webpack_require__(50327));
var Navigation_1 = __importDefault(__webpack_require__(73095));
var CenturyView_1 = __importDefault(__webpack_require__(56939));
var DecadeView_1 = __importDefault(__webpack_require__(76393));
var YearView_1 = __importDefault(__webpack_require__(24583));
var MonthView_1 = __importDefault(__webpack_require__(7630));
var dates_1 = __webpack_require__(71474);
var propTypes_1 = __webpack_require__(94038);
var utils_1 = __webpack_require__(42784);
...
var Calendar = (0, react_1.forwardRef)(function Calendar(props, ref) {
    ...
    }) : defaultValue !== null && defaultValue !== undefined ? toDate(defaultValue) : defaultValue), valueState = _l[0], setValueState = _l[1];
    ...
    function renderContent(next) {
        var currentActiveStartDate = next ? (0, dates_1.getBeginNext)(view, activeStartDate) : (0, dates_1.getBegin)(view, activeStartDate);
        ...
        switch(view){
            case "century":
                {
                    return react_1.default.createElement(CenturyView_1.default, __assign({
                        formatYear: formatYear
                    }, commonProps));
                }
            case "decade":
                {
                    return react_1.default.createElement(DecadeView_1.default, __assign({
                        formatYear: formatYear
                    }, commonProps));
                }
            case "year":
                {
                    return react_1.default.createElement(YearView_1.default, __assign({
            ...
            case "month":
                {
                    return react_1.default.createElement(MonthView_1.default, __assign({
    ...
    return react_1.default.createElement("div", {
        className: (0, clsx_1.default)(baseClassName, selectRange && valueArray.length === 1 && "".concat(baseClassName, "--selectRange"), showDoubleView && "".concat(baseClassName, "--doubleView"), className),
        ref: inputRef
    }, renderNavigation(), react_1.default.createElement("div", {
...
var isValue = prop_types_1.default.oneOfType([
    prop_types_1.default.string,
    prop_types_1.default.instanceOf(Date)
]);
var isValueOrValueArray = prop_types_1.default.oneOfType([
    isValue,
    (0, propTypes_1.rangeOf)(isValue)
]);
Calendar.propTypes = {
    ...
    navigationAriaLive: prop_types_1.default.oneOf([
        "off",
        "polite",
        "assertive"
    ]),
    ...
    returnValue: prop_types_1.default.oneOf([
        "start",
        "end",
        "range"
    ]),
    ...
    tileClassName: prop_types_1.default.oneOfType([
        prop_types_1.default.func,
        propTypes_1.isClassName
    ]),
    tileContent: prop_types_1.default.oneOfType([
        prop_types_1.default.func,
...
var react_1 = __importDefault(__webpack_require__(46261));
var prop_types_1 = __importDefault(__webpack_require__(11770));
var get_user_locale_1 = __webpack_require__(29504);
var dates_1 = __webpack_require__(71474);
var dateFormatter_1 = __webpack_require__(10211);
var propTypes_1 = __webpack_require__(94038);
...
function Navigation(_a) {
    ...
    var previousActiveStartDate2 = shouldShowPrevNext2Buttons ? (0, dates_1.getBeginPrevious2)(view, activeStartDate) : undefined;
    var nextActiveStartDate = (0, dates_1.getBeginNext)(view, activeStartDate);
    var nextActiveStartDate2 = shouldShowPrevNext2Buttons ? (0, dates_1.getBeginNext2)(view, activeStartDate) : undefined;
    ...
    function renderButton() {
        ...
        }, renderLabel(activeStartDate)), showDoubleView ? react_1.default.createElement(react_1.default.Fragment, null, react_1.default.createElement("span", {
    ...
    return react_1.default.createElement("div", {
        className: className
    }, prev2Label !== null && shouldShowPrevNext2Buttons ? react_1.default.createElement("button", {
        "aria-label": prev2AriaLabel,
        className: "".concat(className, "__arrow ").concat(className, "__prev2-button"),
        disabled: prev2ButtonDisabled,
        onClick: onClickPrevious2,
        type: "button"
    }, prev2Label) : null, prevLabel !== null && react_1.default.createElement("button", {
        "aria-label": prevAriaLabel,
        className: "".concat(className, "__arrow ").concat(className, "__prev-button"),
        disabled: prevButtonDisabled,
        onClick: onClickPrevious,
        type: "button"
    }, prevLabel), renderButton(), nextLabel !== null && react_1.default.createElement("button", {
        "aria-label": nextAriaLabel,
        className: "".concat(className, "__arrow ").concat(className, "__next-button"),
        disabled: nextButtonDisabled,
        onClick: onClickNext,
        type: "button"
    }, nextLabel), next2Label !== null && shouldShowPrevNext2Buttons ? react_1.default.createElement("button", {
...
var react_1 = __importDefault(__webpack_require__(46261));
var Decades_1 = __importDefault(__webpack_require__(61851));
...
var react_1 = __importDefault(__webpack_require__(46261));
var prop_types_1 = __importDefault(__webpack_require__(11770));
var date_utils_1 = __webpack_require__(32955);
var Tile_1 = __importDefault(__webpack_require__(48093));
var dates_1 = __webpack_require__(71474);
var dateFormatter_1 = __webpack_require__(10211);
var propTypes_1 = __webpack_require__(94038);
var className = "react-calendar__century-view__decades__decade";
function Decade(_a) {
    var _b = _a.classes, classes = _b === void 0 ? [] : _b, _c = _a.formatYear, formatYear = _c === void 0 ? dateFormatter_1.formatYear : _c, otherProps = __rest(_a, [
        "classes",
        "formatYear"
    ]);
    var date = otherProps.date, locale = otherProps.locale;
    return react_1.default.createElement(Tile_1.default, __assign({}, otherProps, {
        classes: __spreadArray(__spreadArray([], classes, true), [
            className
        ], false),
        maxDateTransform: date_utils_1.getDecadeEnd,
        minDateTransform: date_utils_1.getDecadeStart,
        view: "century"
    }), (0, dates_1.getDecadeLabel)(locale, formatYear, date));
}
exports["default"] = Decade;
Decade.propTypes = __assign(__assign({}, propTypes_1.tileProps), {
    formatYear: prop_types_1.default.func
});
...
var react_1 = __importDefault(__webpack_require__(46261));
var date_utils_1 = __webpack_require__(32955);
var TileGroup_1 = __importDefault(__webpack_require__(13103));
var Decade_1 = __importDefault(__webpack_require__(33600));
var dates_1 = __webpack_require__(71474);
var propTypes_1 = __webpack_require__(94038);
function Decades(props) {
    ...
    var end = start + 99;
    return react_1.default.createElement(TileGroup_1.default, __assign({}, props, {
        className: "react-calendar__century-view__decades",
        dateTransform: date_utils_1.getDecadeStart,
        dateType: "decade",
        end: end,
        start: start,
        step: 10,
        tile: Decade_1.default
    }));
}
...
var react_1 = __importDefault(__webpack_require__(46261));
var Years_1 = __importDefault(__webpack_require__(84752));
...
function Year(_a) {
    ...
    return react_1.default.createElement(Tile_1.default, __assign({}, otherProps, {
        ...
        maxDateTransform: date_utils_1.getYearEnd,
        minDateTransform: date_utils_1.getYearStart,
        view: "decade"
    }), formatYear(locale, date));
}
exports["default"] = Year;
Year.propTypes = __assign(__assign({}, propTypes_1.tileProps), {
    formatYear: prop_types_1.default.func
});
...
var react_1 = __importDefault(__webpack_require__(46261));
var TileGroup_1 = __importDefault(__webpack_require__(13103));
var Year_1 = __importDefault(__webpack_require__(33424));
var dates_1 = __webpack_require__(71474);
var propTypes_1 = __webpack_require__(94038);
...
function Flex(_a) {
    ...
    }, otherProps), react_1.default.Children.map(children, function(child, index) {
...
Flex.propTypes = {
    ...
    style: prop_types_1.default.objectOf(prop_types_1.default.oneOfType([
        prop_types_1.default.string,
...
var prop_types_1 = __importDefault(__webpack_require__(11770));
var clsx_1 = __importDefault(__webpack_require__(50327));
var Days_1 = __importDefault(__webpack_require__(61496));
var Weekdays_1 = __importDefault(__webpack_require__(30238));
var WeekNumbers_1 = __importDefault(__webpack_require__(61721));
var const_1 = __webpack_require__(7648);
var propTypes_1 = __webpack_require__(94038);
...
function MonthView(props) {
    ...
    function renderWeekdays() {
        return react_1.default.createElement(Weekdays_1.default, {
            calendarType: calendarType,
            formatShortWeekday: formatShortWeekday,
            formatWeekday: formatWeekday,
            locale: locale,
    ...
    function renderWeekNumbers() {
        ...
        return react_1.default.createElement(WeekNumbers_1.default, {
            activeStartDate: activeStartDate,
            calendarType: calendarType,
            onClickWeekNumber: onClickWeekNumber,
            onMouseLeave: onMouseLeave,
    ...
    function renderDays() {
        return react_1.default.createElement(Days_1.default, __assign({
            calendarType: calendarType
        }, childProps));
    }
    var className = "react-calendar__month-view";
    return react_1.default.createElement("div", {
        className: (0, clsx_1.default)(className, showWeekNumbers ? "".concat(className, "--weekNumbers") : "")
    }, react_1.default.createElement("div", {
        style: {
            display: "flex",
            alignItems: "flex-end"
        }
    }, renderWeekNumbers(), react_1.default.createElement("div", {
        style: {
            flexGrow: 1,
            width: "100%"
        }
...
MonthView.propTypes = __assign(__assign({}, propTypes_1.tileGroupProps), {
    calendarType: propTypes_1.isCalendarType,
    formatDay: prop_types_1.default.func,
    formatLongDate: prop_types_1.default.func,
    formatShortWeekday: prop_types_1.default.func,
...
function Day(_a) {
    var calendarTypeOrDeprecatedCalendarType = _a.calendarType, _b = _a.classes, classes = _b === void 0 ? [] : _b, currentMonthIndex = _a.currentMonthIndex, _c = _a.formatDay, formatDay = _c === void 0 ? dateFormatter_1.formatDay : _c, _d = _a.formatLongDate, formatLongDate = _d === void 0 ? dateFormatter_1.formatLongDate : _d, otherProps = __rest(_a, [
        "calendarType",
        "classes",
        "currentMonthIndex",
        "formatDay",
    ...
    return react_1.default.createElement(Tile_1.default, __assign({}, otherProps, {
        ...
        maxDateTransform: date_utils_1.getDayEnd,
        minDateTransform: date_utils_1.getDayStart,
        view: "month"
    }), formatDay(locale, date));
}
exports["default"] = Day;
Day.propTypes = __assign(__assign({}, propTypes_1.tileProps), {
    currentMonthIndex: prop_types_1.default.number.isRequired,
    formatDay: prop_types_1.default.func,
    formatLongDate: prop_types_1.default.func
});
...
var date_utils_1 = __webpack_require__(32955);
var TileGroup_1 = __importDefault(__webpack_require__(13103));
var Day_1 = __importDefault(__webpack_require__(3570));
var dates_1 = __webpack_require__(71474);
var propTypes_1 = __webpack_require__(94038);
var utils_1 = __webpack_require__(42784);
function Days(props) {
    var activeStartDate = props.activeStartDate, calendarTypeOrDeprecatedCalendarType = props.calendarType;
    var showFixedNumberOfWeeks = props.showFixedNumberOfWeeks, showNeighboringMonth = props.showNeighboringMonth, otherProps = __rest(props, [
    ...
    return react_1.default.createElement(TileGroup_1.default, __assign({}, otherProps, {
...
var prop_types_1 = __importDefault(__webpack_require__(11770));
var date_utils_1 = __webpack_require__(32955);
var WeekNumber_1 = __importDefault(__webpack_require__(77945));
var Flex_1 = __importDefault(__webpack_require__(62632));
var dates_1 = __webpack_require__(71474);
var propTypes_1 = __webpack_require__(94038);
var utils_1 = __webpack_require__(42784);
function WeekNumbers(props) {
    ...
    var weekNumbers = dates.map(function(date) {
        return (0, dates_1.getWeekNumber)(date, calendarType);
    });
    return react_1.default.createElement(Flex_1.default, {
        ...
        return react_1.default.createElement(WeekNumber_1.default, {
            key: weekNumber,
            date: date,
            onClickWeekNumber: onClickWeekNumber,
...
function Weekdays(props) {
    ...
    for(var weekday = 1; weekday <= 7; weekday += 1){
        ...
        weekdays.push(react_1.default.createElement("div", {
            key: weekday,
            className: (0, clsx_1.default)(weekdayClassName, (0, dates_1.isCurrentDayOfWeek)(weekdayDate) && "".concat(weekdayClassName, "--current"), (0, dates_1.isWeekend)(weekdayDate, calendarType) && "".concat(weekdayClassName, "--weekend"))
...
function Tile(props) {
    ...
    return react_1.default.createElement("button", {
        className: (0, clsx_1.default)(classes, tileClassName),
        ...
        style: style,
        type: "button"
    }, formatAbbr ? react_1.default.createElement("abbr", {
        "aria-label": formatAbbr(locale, date)
    }, children) : children, tileContent);
}
exports["default"] = Tile;
Tile.propTypes = __assign(__assign({}, propTypes_1.tileProps), {
    children: prop_types_1.default.node.isRequired,
    formatAbbr: prop_types_1.default.func,
    maxDateTransform: prop_types_1.default.func.isRequired,
    minDateTransform: prop_types_1.default.func.isRequired
});
...
function TileGroup(_a) {
    var className = _a.className, _b = _a.count, count = _b === void 0 ? 3 : _b, dateTransform = _a.dateTransform, dateType = _a.dateType, end = _a.end, hover = _a.hover, offset = _a.offset, start = _a.start, _c = _a.step, step = _c === void 0 ? 1 : _c, Tile = _a.tile, value = _a.value, valueType = _a.valueType, tileProps = __rest(_a, [
        "className",
        "count",
        "dateTransform",
        "dateType",
    ...
    for(var point = start; point <= end; point += step){
        ...
        tiles.push(react_1.default.createElement(Tile, __assign({
            key: date.getTime(),
            classes: (0, utils_1.getTileClasses)({
                value: value,
                valueType: valueType,
                date: date,
                dateType: dateType,
...
TileGroup.propTypes = __assign(__assign({}, propTypes_1.tileGroupProps), {
    className: prop_types_1.default.string,
    count: prop_types_1.default.number,
    dateTransform: prop_types_1.default.func.isRequired,
    dateType: prop_types_1.default.string,
    end: prop_types_1.default.number.isRequired,
    offset: prop_types_1.default.number,
    step: prop_types_1.default.number,
    start: prop_types_1.default.number.isRequired,
    tile: prop_types_1.default.func.isRequired
});
...
var react_1 = __importDefault(__webpack_require__(46261));
var Months_1 = __importDefault(__webpack_require__(82344));
...
function Month(_a) {
    var _b = _a.classes, classes = _b === void 0 ? [] : _b, _c = _a.formatMonth, formatMonth = _c === void 0 ? dateFormatter_1.formatMonth : _c, _d = _a.formatMonthYear, formatMonthYear = _d === void 0 ? dateFormatter_1.formatMonthYear : _d, otherProps = __rest(_a, [
        "classes",
        "formatMonth",
        "formatMonthYear"
    ]);
    ...
    return react_1.default.createElement(Tile_1.default, __assign({}, otherProps, {
        ...
        maxDateTransform: date_utils_1.getMonthEnd,
        minDateTransform: date_utils_1.getMonthStart,
        view: "year"
    }), formatMonth(locale, date));
}
exports["default"] = Month;
Month.propTypes = __assign(__assign({}, propTypes_1.tileProps), {
    formatMonth: prop_types_1.default.func,
    formatMonthYear: prop_types_1.default.func
});
...
var date_utils_1 = __webpack_require__(32955);
var TileGroup_1 = __importDefault(__webpack_require__(13103));
var Month_1 = __importDefault(__webpack_require__(84445));
var propTypes_1 = __webpack_require__(94038);
function Months(props) {
    ...
    return react_1.default.createElement(TileGroup_1.default, __assign({}, props, {
        ...
        start: start,
        tile: Month_1.default
    }));
}
exports["default"] = Months;
Months.propTypes = __assign(__assign({}, propTypes_1.tileGroupProps), {
    locale: prop_types_1.default.string
});
...
var Calendar_1 = __importDefault(__webpack_require__(65390));
__webpack_unused_export__ = Calendar_1.default;
var Navigation_1 = __importDefault(__webpack_require__(73095));
__webpack_unused_export__ = Navigation_1.default;
var CenturyView_1 = __importDefault(__webpack_require__(56939));
__webpack_unused_export__ = CenturyView_1.default;
var DecadeView_1 = __importDefault(__webpack_require__(76393));
__webpack_unused_export__ = DecadeView_1.default;
var YearView_1 = __importDefault(__webpack_require__(24583));
__webpack_unused_export__ = YearView_1.default;
var MonthView_1 = __importDefault(__webpack_require__(7630));
__webpack_unused_export__ = MonthView_1.default;
exports.ZP = Calendar_1.default;
...
exports.CALENDAR_TYPE_LOCALES = (_a = {}, _a[exports.CALENDAR_TYPES.GREGORY] = [
    "en-CA",
    "en-US",
    "es-AR",
    "es-BO",
    ...
    "es-VE",
    "pt-BR"
], _a[exports.CALENDAR_TYPES.HEBREW] = [
    "he",
    "he-IL"
...
var get_user_locale_1 = __importDefault(__webpack_require__(29504));
 ...
 */ function getDayOfWeek(date, calendarType) {
    if (calendarType === void 0) {
        calendarType = const_1.CALENDAR_TYPES.ISO_8601;
    }
...
function toYearLabel(locale, formatYear, dates) {
    if (formatYear === void 0) {
        formatYear = dateFormatter_1.formatYear;
    }
...
var tiny_warning_1 = __importDefault(__webpack_require__(81329));
var const_1 = __webpack_require__(7648);
var dates_1 = __webpack_require__(71474);
/**
...
var calendarTypeMap = (_a = {}, _a[const_1.DEPRECATED_CALENDAR_TYPES.ARABIC] = const_1.CALENDAR_TYPES.ISLAMIC, _a[const_1.DEPRECATED_CALENDAR_TYPES.HEBREW] = const_1.CALENDAR_TYPES.HEBREW, _a[const_1.DEPRECATED_CALENDAR_TYPES.ISO_8601] = const_1.CALENDAR_TYPES.ISO_8601, _a[const_1.DEPRECATED_CALENDAR_TYPES.US] = const_1.CALENDAR_TYPES.GREGORY, _a);
...
var lodash_memoize_1 = __importDefault(__webpack_require__(31313));
